        ...
        return (
            <div>
                <div className="container">
                    <div className="m-auto px-sm-3 px-0 pb-0 pb-sm-5">
                        <h1 className='h1-responsive py-4 py-sm-5 m-0 font-weight-bold w-100 text-center'>Салон краси та магазин Iвон</h1>
