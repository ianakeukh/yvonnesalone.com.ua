            ...
            <div>
                <div className='container  justify-content-center m-auto pb-5 contacts px-1'>
                    <div className='price w-100 m-auto justify-content-center'>
                        <h1 className='h1-responsive py-4 py-sm-5 m-0 font-weight-bold w-100 text-center'>Форма зв'язку</h1>
                        <MDBCard className='px-0 px-sm-3 m-auto justify-content-center contact-card'>
                            <MDBRow className='pt-0 px-0 px-sm-3'>
                                <div lg="12" className='w-100'>
                                    <MDBCardBody className="form px-0 px-sm-3">
