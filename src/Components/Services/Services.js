               ...
               <Router>
                   <div>
                       <div className='container block text-center justify-content-center m-auto pb-5 p-0 px-sm-3'>
                           <h1 className='h1-responsive py-4 py-sm-5 m-0 font-weight-bold text-center'>Послуги</h1>
                           <div className='w-100 m-auto'>
                               <div className=' d-flex m-auto flex-wrap justify-content-center px-0'>
                                   <div className='bl'>
                                       <MDBView hover zoom className='w-100'>
                                           <img
                                   ...
                                   <div className='bl shadow-box-example hoverable' style={pinkColor}>
                                           <p className='serv white-text w-100 text-center'>ЗАЧІСКИ</p>
                                   </div>
                                   <div className='bl'>
                                       <MDBView hover zoom className='w-100'>
                                           <img
                                   ...
                                   <div className='bl shadow-box-example hoverable' style={pinkColor}>
                                            <p className='serv white-text w-100 text-center'>СТРИЖКИ</p>
                                   </div>
                                   <div className='bl'>
                                       <MDBView hover zoom className='w-100'>
                                           <img
