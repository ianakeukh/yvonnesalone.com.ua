                                    ...
                                    >
                                        <MDBNavbarNav className='float-left p-3'>
                                            <MDBNavItem className='py-2' active>
                                                <Link to='/' onClick={this.toggleCollapse('navbarCollapse1')} className=' font-weight-normal text-white'>Головна</Link>
                                            </MDBNavItem>
                                            <MDBNavItem className='py-2'>
                                                <Link to='./AboutSalon' onClick={this.toggleCollapse('navbarCollapse1')} className='font-weight-normal text-white'>Про салон</Link>
                                            </MDBNavItem>
                                            <MDBNavItem className='py-2'>
                                                <Link to='./Service' onClick={this.toggleCollapse('navbarCollapse1')} className='font-weight-normal text-white'>Послуги</Link>
                                            </MDBNavItem>
                                            <MDBNavItem className='py-2'>
                                                <Link to='./photos' onClick={this.toggleCollapse('navbarCollapse1')} className='font-weight-normal text-white'>Галерея</Link>
                                            </MDBNavItem>
                                            <MDBNavItem className='py-2'>
                                                <Link to='./price' onClick={this.toggleCollapse('navbarCollapse1')} className='font-weight-normal text-white'>Ціни</Link>
                                            </MDBNavItem>
                                            <MDBNavItem className='py-2'>
                                                <Link to='./contacts' onClick={this.toggleCollapse('navbarCollapse1')} className='font-weight-normal text-white'>Контакти</Link>
                                            </MDBNavItem>
                                        </MDBNavbarNav>
                                    </MDBCollapse>
                                </MDBContainer>
